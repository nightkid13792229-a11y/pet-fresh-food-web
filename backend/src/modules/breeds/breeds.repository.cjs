...
const findAllBreeds = async (options = {}) => {
...
const updateBreed = async (id, payload) => {
  const fields = [];
  const params = [];
...
const getBreedCategories = async () => {
